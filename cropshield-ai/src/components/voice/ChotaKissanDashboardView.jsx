        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300 border border-emerald-300 font-mono">
                <Radio className="w-3 h-3 text-emerald-600 animate-pulse" />
                Live Farm Agro-Intelligence
              </span>
            </div>
