...
export const FarmerBottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white/95 backdrop-blur-md border-t border-gray-200/90 px-3 py-2 z-40 shadow-lg select-none">
