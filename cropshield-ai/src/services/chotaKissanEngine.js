...
export const ASSISTANT_UI_STRINGS = {
  en: {
    ...
    greeting: "Hello! I am Chota Kissan, your AI farm assistant. Speak naturally in any language — ask me about your crops, diseases, medicines, weather, or market rates!",
    ...
    speaking: 'Chota Kissan is speaking...',
    stopSpeaking: 'Stop Audio',
    tryAsking: 'Try asking Chota Kissan:',
  ...
  hi: {
    ...
    greeting: "नमस्ते! मैं छोटा किसान हूँ, आपका एआई कृषि साथी। अपनी भाषा में खुलकर बोलिए — फसल की बीमारी, दवा, मौसम या मंडी भाव के बारे में पूछें!",
    ...
    speaking: 'छोटा किसान बोल रहा है...',
    stopSpeaking: 'आवाज रोकें',
    tryAsking: 'छोटा किसान से पूछें:',
  ...
  mr: {
    ...
    greeting: "नमस्कार! मी छोटा किसान, आपला एआय कृषी साथीदार. आपल्या भाषेत बोला — पिकांचे रोग, औषध फवारणी, हवामान किंवा बाजारभावाबद्दल विचारा!",
    ...
    speaking: 'छोटा किसान बोलत आहे...',
    stopSpeaking: 'आवाज थांबवा',
    tryAsking: 'छोटा किसानला विचारा:',
  ...
  ta: {
    ...
    greeting: "வணக்கம்! நான் சோட்டா கிசான், உங்கள் AI விவசாய தோழன். உங்கள் தாய்மொழியில் இயல்பாக பேசுங்கள் — பயிர் நோய், மருந்து தெளிப்பு, வானிலை அல்லது சந்தை விலை பற்றி கேளுங்கள்!",
    ...
    speaking: 'சோட்டா கிசான் பேசுகிறார்...',
    stopSpeaking: 'குரலை நிறுத்து',
    tryAsking: 'சோட்டா கிசானிடம் கேட்கலாம்:',
  ...
  te: {
    ...
    greeting: "నమస్కారం! నేను చోటా కిసాన్, మీ AI వ్యవసాయ మిత్రుడిని. మీ పంటల వ్యాధులు, మందులు, వాతావరణం లేదా మార్కెట్ ధరల గురించి అడగండి!",
    ...
    speaking: 'చోటా కిసాన్ మాట్లాడుతున్నారు...',
    stopSpeaking: 'వాయిస్ ఆపు',
    tryAsking: 'చోటా కిసాన్‌ను అడగండి:',
  ...
  kn: {
    ...
    greeting: "ನಮಸ್ಕಾರ! ನಾನು ಛೋಟಾ ಕಿಸಾನ್, ನಿಮ್ಮ AI ಕೃಷಿ ಮಿತ್ರ. ಬೆಳೆ ರೋಗ, ಔಷಧಿ, ಹವಾಮಾನ ಅಥವಾ ಮಾರುಕಟ್ಟೆ ದರಗಳ ಬಗ್ಗೆ ಕೇಳಿ!",
    ...
    speaking: 'ಛೋಟಾ ಕಿಸಾನ್ ಮಾತನಾಡುತ್ತಿದ್ದಾರೆ...',
    stopSpeaking: 'ಧ್ವನಿ ನಿಲ್ಲಿಸಿ',
    tryAsking: 'ಛೋಟಾ ಕಿಸಾನ್ ಅವರನ್ನು ಕೇಳಿ:',
...
सांगा, मी लगेच उत्तर देतो!`,
        ...
        kn: `ನಮಸ್ಕಾರ! ನಾನು ಛೋಟಾ ಕಿಸಾನ್ 🌱 ನಿಮ್ಮ AI ಕೃಷಿ ಮಿತ್ರ. ಇಂದು ನಾನು ನಿಮ್ಮ ಜಮೀನಿಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಲಿ? ಬೆಳೆ ರೋಗಗಳು, ಗೊಬ್ಬರ ಅಥವಾ ಮಾರುಕಟ್ಟೆ ಬೆಲೆಗಳ ಬಗ್ಗೆ ಕೇಳಿ!`,
        gu: `નમસ્તે! હું છોટા કિસાન છું 🌱 તમારો AI કૃષિ મિત્ર. આજે હું તમારા ખેતરમાં શું મદદ કરું? પાકના રોગ, ખાતર કે મંડી ભાવ વિશે પૂછો!`,
        bn: `নমস্কার! আমি ছোট কিষাণ 🌱 আপনার AI কৃষি বন্ধু। আজ আমি আপনার ফসলের কী সাহায্য করতে পারি? রোগ, সার বা বাজার দর সম্পর্কে জিজ্ঞাসা করুন!`,
        ml: `നമസ്കാരം! ഞാൻ ചോറ്റാ കിസാൻ 🌱 നിങ്ങളുടെ AI കാർഷിക സുഹൃത്ത്. ഇന്ന് ഞാൻ നിങ്ങളുടെ കൃഷിയിടത്തിൽ എന്താണ് സഹായിക്കേണ്ടത്?`,
        pa: `ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ! ਮੈਂ ਛੋਟਾ ਕਿਸਾਨ ਹਾਂ 🌱 ਤੁਹਾਡਾ AI ਖੇਤੀਬਾੜੀ ਦੋਸਤ। ਅੱਜ ਮੈਂ ਤੁਹਾਡੇ ਖੇਤ ਲਈ ਕੀ ਮਦਦ ਕਰਾਂ?`,
        en: `Hello! I am Chota Kissan 🌱 your AI farming companion.
...
Feel free to ask me anything about your crops!`
    ...
    case 'bot_identity': {
      const identityMap = {
        ta: `நான் **சோட்டா கிசான் (Chota Kissan)** — பயிர் பாதுகாப்பு AI குரல் உதவியாளர்.
...
5. 🌾 **நேரடி மண்டி விலை**: சாங்லி மற்றும் அருகிலுள்ள சந்தை விலைகளை உடனுக்குடன் கூறுவேன்.`,
        hi: `मैं **छोटा किसान (Chota Kissan)** हूँ — आपका समर्पित एआई कृषि विशेषज्ञ।
...
5. 🌾 **मंडी भाव**: लाइव APMC रेट्स।`,
        mr: `मी **छोटा किसान (Chota Kissan)** आहे — आपला स्मार्ट एआय शेती मार्गदर्शक.
...
४. 🌾 **थेट बाजारभाव**: जिल्ह्यातील कृषी उत्पन्न बाजार समितीचे ताजे भाव देणे.`,
        en: `I am **Chota Kissan** — CropShield AI's smart agricultural voice assistant.
...
3. **பிரதான் மந்திரி பயிர் காப்பீடு (PMFBY)**: ₹1 டோக்கன் கட்டணத்தில் முழு பயிர் காப்பீடு.`,
    ...
    default: {
      const assistantHelpMap = {
        ta: `வணக்கம்! நான் சோட்டா கிசான் AI உதவியாளன். பயன்பாட்டின் மொழியை மாற்றவோ, பக்கங்களை திறக்கவோ, பயிர் நோய்கள், உரம், வானிலை அல்லது மண்டி விலைகள் பற்றி அறியவோ என்னிடம் கேட்கலாம். உங்களுக்கு எப்படி உதவ வேண்டும்?`,
        hi: `नमस्ते! मैं छोटा किसान एआई सहायक हूँ। आप मुझसे भाषा बदलने, ऐप के सेक्शन खोलने, फसल की बीमारी, खाद, मौसम या मंडी भाव की जानकारी ले सकते हैं। मैं आपकी क्या मदद करूँ?`,
        mr: `नमस्कार! मी छोटा किसान एआई सहाय्यक आहे. आपण मला भाषा बदलण्यासाठी, ॲपचे विभाग उघडण्यासाठी, पीक रोग, खत, हवामान किंवा बाजारभावाची माहिती विचारू शकता. मी आपली काय मदत करू?`,
        en: `Hello! I am your Chota Kissan AI assistant. You can ask me to change application language, navigate features, check crop diseases, fertilizer dosage, weather, or mandi prices. How can I help you today?`
      };
