/**
 * CropShield AI - "Kisan One" Multilingual AI Voice Assistant Engine (v3.0)
 * 
...
export const ASSISTANT_UI_STRINGS = {
  ...
  gu: {
    ...
    greeting: "નમસ્તે! હું કિસાન વન છું, તમારો AI ખેતી સાથી. પાક રોગ, દવા, હવામાન કે બજારભાવ વિશે પૂછો!",
    ...
    speaking: 'કિસાન વન બોલી રહ્યા છે...',
    stopSpeaking: 'અવાજ બંધ કરો',
    tryAsking: 'કિસાન વનને પૂછો:',
  ...
  bn: {
    ...
    greeting: "নমস্কার! আমি কিসান ওয়ান, আপনার AI কৃষি সঙ্গী। ফসলের রোগ, ওষুধ, আবহাওয়া বা বাজার দর সম্পর্কে জিজ্ঞাসা করুন!",
    tapToTalk: 'কথা বলতে স্পর্শ করুন',
    listening: 'শুনছি...',
    processing: 'বুঝতে পারছি...',
    analyzingFarm: 'খামারের সেন্সর ও রোগ পূর্বাভাস যাচাই করা হচ্ছে...',
    speaking: 'কিসান ওয়ান কথা বলছেন...',
    stopSpeaking: 'ভয়েস বন্ধ করুন',
    tryAsking: 'কিসান ওয়ানকে জিজ্ঞাসা করুন:',
  ...
  pa: {
    ...
    greeting: "ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ! ਮੈਂ ਕਿਸਾਨ ਵਨ ਹਾਂ, ਤੁਹਾਡਾ AI ਖੇਤੀ ਸਾਥੀ। ਫਸਲਾਂ ਦੇ ਰੋਗ, ਦਵਾਈ, ਮੌਸਮ ਜਾਂ ਮੰਡੀ ਭਾਅ ਬਾਰੇ ਪੁੱਛੋ!",
    tapToTalk: 'ਬੋਲਣ ਲਈ ਦਬਾਓ',
    listening: 'ਸੁਣ ਰਿਹਾ ਹਾਂ...',
    processing: 'ਸਮਝ ਰਿਹਾ ਹਾਂ...',
    analyzingFarm: 'ਖੇਤ ਦੇ ਸੈਂਸਰ ਅਤੇ ਰੋਗ ਮਾਡਲ ਦੀ ਜਾਂਚ ਜਾਰੀ...',
    speaking: 'ਕਿਸਾਨ ਵਨ ਬੋਲ ਰਿਹਾ ਹੈ...',
    stopSpeaking: 'ਅਵਾਜ਼ ਰੋਕੋ',
    tryAsking: 'ਕਿਸਾਨ ਵਨ ਨੂੰ ਪੁੱਛੋ:',
  ...
  ml: {
    ...
    greeting: "നമസ്കാരം! ഞാൻ കിസാൻ വൺ, നിങ്ങളുടെ AI കാർഷിക സഹായി. വിള രോഗങ്ങൾ, മരുന്ന്, കാലാവസ്ഥ അല്ലെങ്കിൽ മാർക്കറ്റ് വിലയെക്കുറിച്ച് ചോദിക്കൂ!",
    ...
    speaking: 'കിസാൻ വൺ സംസാരിക്കുന്നു...',
...
export function classifyAgriculturalIntent(query = '', context = {}) {
  ...
  if (textMatchesAny(q, ['open', 'show', 'go to', 'navigate', 'திற', 'காட்டு', 'போ', 'उघड', 'दाखवा', 'खोलो', 'दिखाओ', 'ले चलो', 'తెరువు', 'చూపించు', 'ತೆರೆ', 'ತೋರಿಸು'])) {
    if (textMatchesAny(q, ['scan', 'camera', 'photo', 'இலை', 'படம்', 'கண்', 'फोटो', 'स्कॅन', 'स्कैनर', 'ఫోటో', 'ಸ್ಕ್ಯಾನ್'])) {
    ...
    if (textMatchesAny(q, ['roi', 'calculator', 'yield', 'லாபம்', 'நஷ்டம்', 'கணக்கீடு', 'கணக்கிடு', 'கேல்குலேட்டர்', 'मुनाफा', 'कॅल्क्युलेटर'])) {
      return { intent: 'app_navigation', target: 'roiCalculator', label: 'ROI Calculator', targetCrop };
    }
  ...
  // Standalone strong noun matches for App Navigation (if verb is missing)
  if (textMatchesAny(q, ['roi', 'calculator', 'கேல்குலேட்டர்', 'मुनाफा कॅल्क्युलेटर'])) {
    return { intent: 'app_navigation', target: 'roiCalculator', label: 'ROI Calculator', targetCrop };
  }
  if (textMatchesAny(q, ['dashboard', 'டேஷ்போர்டு', 'डॅशबोर्ड'])) {
    return { intent: 'app_navigation', target: 'home', label: 'Farm Dashboard', targetCrop };
  }
...
export function generateChotaKissanResponse({
  ...
  switch (classifiedIntent.intent) {
    ...
    case 'greeting': {
      const greetingMap = {
        ta: `வணக்கம்! நான் கிசான் ஒன் 🌱 உங்கள் AI விவசாய தோழன்.
...
தயங்காமல் கேளுங்கள், உங்களுக்கு உதவ நான் எப்போதும் தயார்!`,
        hi: `नमस्ते! मैं किसान वन हूँ 🌱 आपका एआई कृषि साथी।
...
बेझिझक बोलिए, मैं आपकी सेवा में हाजिर हूँ!`,
        mr: `नमस्कार! मी किसान वन 🌱 आपला एआय कृषी मित्र.
...
सांगा, मी लगेच उत्तर देतो!`,
        ...
        en: `Hello! I am Kisan One 🌱 your AI farming companion.
...
Feel free to ask me anything about your crops!`
    ...
    case 'bot_identity': {
      const identityMap = {
        ta: `நான் **கிசான் ஒன் (Kisan One)** — பயிர் பாதுகாப்பு AI குரல் உதவியாளர்.
...
5. 🌾 **நேரடி மண்டி விலை**: சாங்லி மற்றும் அருகிலுள்ள சந்தை விலைகளை உடனுக்குடன் கூறுவேன்.`,
        hi: `मैं **किसान वन (Kisan One)** हूँ — आपका समर्पित एआई कृषि विशेषज्ञ।
...
5. 🌾 **मंडी भाव**: लाइव APMC रेट्स।`,
        mr: `मी **किसान वन (Kisan One)** आहे — आपला स्मार्ट एआय शेती मार्गदर्शक.
...
४. 🌾 **थेट बाजारभाव**: जिल्ह्यातील कृषी उत्पन्न बाजार समितीचे ताजे भाव देणे.`,
        en: `I am **Kisan One** — CropShield AI's smart agricultural voice assistant.
...
3. **பிரதான் மந்திரி பயிர் காப்பீடு (PMFBY)**: ₹1 டோக்கன் கட்டணத்தில் முழு பயிர் காப்பீடு.`,
    ...
    default: {
      const assistantHelpMap = {
        ...
        en: `Hello! I am your Kisan One AI assistant. You can ask me to change application language, navigate features, check crop diseases, fertilizer dosage, weather, or mandi prices. How can I help you today?`
      };
